...
class Order(SQLModel, table=True):
    ...
    user: User = Relationship(back_populates="orders", ondelete="CASCADE", onupdate="CASCADE")
    item: Item = Relationship(back_populates="orders", ondelete="CASCADE", onupdate="CASCADE")
